...
https://github.com/Cadene/pretrained-models.pytorch. All the credit
for porting it goes to https://github.com/dichotomies/proxy-nca.
"""


def bn_inception(pretrained=False, **kwargs):
    model = BNInception(**kwargs)
    path = os.path.join('data', 'net', 'bn_inception_weights_pt04.pt')
    if pretrained:
